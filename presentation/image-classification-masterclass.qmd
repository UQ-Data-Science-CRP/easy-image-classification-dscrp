...
![](assets/domain_shift_example.jpeg)
...
1. **Roboflow Playground**
    - https://playground.roboflow.com/object-detection
    - Explore the UI and key features
    - Upload a sample image and see how different open-source models perform
2. **Roboflow Notebooks + Google Colab** (~15 min)
   - Open a prepared notebook
   - Train a classification model on a small dataset
   - Evaluate + download weights
3. **Roboflow Universe** (~15 min)
